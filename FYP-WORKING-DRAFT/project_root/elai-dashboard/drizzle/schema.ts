...
export const alerts = mysqlTable("alerts", {
  ...
  eventCategory: varchar("eventCategory", { length: 32 }).default("malicious").notNull(),
  ...
  primaryPrediction: varchar("primaryPrediction", { length: 128 }),
  secondaryPrediction: varchar("secondaryPrediction", { length: 128 }),
  primaryConfidence: varchar("primaryConfidence", { length: 10 }),
  secondaryConfidence: varchar("secondaryConfidence", { length: 10 }),
  confidenceGap: varchar("confidenceGap", { length: 10 }),
  recommendedAction: varchar("recommendedAction", { length: 64 }),
  isBlocked: int("isBlocked").default(0).notNull(),
  blockStatus: varchar("blockStatus", { length: 32 }).default("not_requested").notNull(),
  blockMessage: text("blockMessage"),
  blockUpdatedAt: timestamp("blockUpdatedAt"),
  edgeDevice: varchar("edgeDevice", { length: 128 }),
