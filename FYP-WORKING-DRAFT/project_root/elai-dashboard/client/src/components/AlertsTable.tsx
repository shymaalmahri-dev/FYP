...
export function AlertsTable({ alerts, isLoading = false, onExport, selectedAlertId, onSelectAlert }: AlertsTableProps) {
  ...
  const filteredAlerts = alerts.filter(
    (alert) =>
      ...
      (categoryFilter === "all" || (alert.eventCategory ?? "malicious") === categoryFilter)
  );
        ...
        <div className="flex gap-2 items-center flex-wrap">
          ...
          <Select value={categoryFilter} onValueChange={setCategoryFilter}>
            ...
            <SelectContent>
              ...
              <SelectItem value="gray_zone">Gray Zone</SelectItem>
              <SelectItem value="normal">Normal Samples</SelectItem>
            </SelectContent>
          </Select>
                ...
                paginatedAlerts.map((alert) => (
                  ...
                  >
                    ...
                    <td className="py-2 px-2">
                      <Badge variant="outline" className="bg-background text-cyan-300 border-cyan-700/20">
                        {(alert.eventCategory ?? "malicious").replace("_", " ")}
                      </Badge>
                    </td>
                    <td className="py-2 px-2">
